...
class _$_Preferences implements _Preferences {
  ...
  @override
  String toString() {
    return 'Preferences(userToken: $userToken, userId: $userId, username: $username, libraryId: $libraryId, serverId: $serverId, playbackSpeed: $playbackSpeed, rewindInterval: $rewindInterval, fastForwardInterval: $fastForwardInterval, baseUrl: $baseUrl, useChapterProgressBar: $useChapterProgressBar)';
  }
